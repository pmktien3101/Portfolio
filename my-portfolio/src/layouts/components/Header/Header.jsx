            ...
            <div className="header-content">
                ...
                <ul className="menu-list">
                    ...
                    <li className="menu-item">
                     ...
                     <li className="menu-item">
                        <NavLink to={ROUTE.SKILL} className={({isActive}) => isActive ? "active" : ""}>Projects</NavLink>  </li>   
                    <li className="menu-item">
                        <NavLink to={ROUTE.PROJECT} className={({isActive}) => isActive ? "active" : ""}>Contact</NavLink>  </li>
                </ul>
            </div>
    )
}
